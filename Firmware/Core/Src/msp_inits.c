...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc) {
  if(hadc->Instance==ADC1)   {
    ...
    PA0     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(AMPERES_GPIO_PORT, AMPERES_ADC_PIN);
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* hcan) {
  ...
  if(hcan->Instance==CAN1)   {
    ...
    PB9     ------> CAN1_TX
    */
    GPIO_InitStruct.Pin = AMPERES_RX_PIN|AMPERES_TX_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_CAN1;
    HAL_GPIO_Init(AMPERES_CAN_PORT, &GPIO_InitStruct);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan) {
  if(hcan->Instance==CAN1) {
    ...
    PB9     ------> CAN1_TX
    */
    HAL_GPIO_DeInit(AMPERES_CAN_PORT, AMPERES_RX_PIN|AMPERES_TX_PIN);
...
void HAL_UART_MspGPIOInit(UART_HandleTypeDef *huart){
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = AMPERES_UART_TX_PIN|AMPERES_UART_RX_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(AMPERES_UART_PORT, &GPIO_InitStruct);
}
